...
class Skroutz(commands.Cog):
    ...
    async def store_id(self, ctx: commands.Context, id, description):
        ...
        if id not in self.bot.guild_data[str(ctx.guild.id)]['skroutz']:
    ...
    async def remove_id(self, ctx: commands.Context, id):
        for i in self.bot.guild_data[str(ctx.guild.id)]['skroutz']:
            if i['id'] == id:
                description = i['description']
                self.bot.guild_data[str(ctx.guild.id)]['skroutz'].remove(i)
