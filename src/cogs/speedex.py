...
class SpeedexTracker(commands.Cog, name="Speedex"):
    def __init__(self, bot: commands.Bot):
        ...
        self.tracker_url = self.tracker_url + "/track-one/speedex/"
    ...
    async def speedex(self, ctx: commands.Context):
        ...
        embed.set_thumbnail(url="https://i.imgur.com/JGaa8zk.png")
    ...
    async def update_ids(self):
        ...
        tracking_ids = sqlite3_handler.get_distinct_tracking_ids_for_courier_name("speedex")
        # Checking each id
        for tracking_id in tracking_ids:
            await self.__check_if_changed(tracking_id)

def setup(bot: commands.Bot):
    bot.add_cog(SpeedexTracker(bot))
