...
class GenikiTracker(commands.Cog, name="Geniki"):
    def __init__(self, bot: commands.Bot):
        ...
        self.tracker_url = self.tracker_url + "/track-one/geniki/"
    ...
    async def update_ids(self):
        ...
        tracking_ids = sqlite3_handler.get_distinct_tracking_ids_for_courier_name("geniki")
        # Checking each id
        for tracking_id in tracking_ids:
            await self.__check_if_changed(tracking_id)

def setup(bot: commands.Bot):
    bot.add_cog(GenikiTracker(bot))
