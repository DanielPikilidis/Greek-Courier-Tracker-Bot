...
class ACSTracker(commands.Cog, name="ACS"):
    def __init__(self, bot: commands.Bot):
        ...
        self.tracker_url = self.tracker_url + "/track-one/acs/"
    ...
    async def acs(self, ctx: commands.Context):
        ...
        embed.set_thumbnail(url="https://i.imgur.com/Yk1WIrQ.jpg")
